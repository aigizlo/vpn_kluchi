...
#         await bot.send_message(chat_id=telegram_id, text=text, parse_mode='HTML', disable_web_page_preview=True, reply_markup=keyboard)
...
#
#         await bot.send_message(chat_id=telegram_id, text=answer, reply_markup=back())
#
#     except Exception as e:
